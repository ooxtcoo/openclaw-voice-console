  ...
  try {
    ...
    if (req.method === 'POST' && u.pathname === '/api/chat') {
      ...
      const voicePrompt = [
        ...
        '',
        'FACE CONTROL:',
        '- You can control the on-screen face by appending ONE extra line at the VERY END:',
        '  FACE: {"mood": <number -1..1>, "wink": "left"|"right"|"both"|null, "arousal": <number 0..1>}',
        '- This FACE line MUST be valid JSON and MUST be the last line.',
        '- Do not mention the FACE line to the user; it will be removed before TTS.',
        '- Use it when your tone implies an expression:',
        '  * friendly / happy / laughing -> mood ~ +0.4..+0.9',
        '  * neutral / informative       -> mood ~ 0.0..+0.2',
        '  * sad / apologetic            -> mood ~ -0.2..-0.6',
        '  * angry / annoyed / strict    -> mood ~ -0.4..-0.9',
        '  * playful emphasis            -> wink left/right',
        '',
        'User input:',
        text,
      ].join('\n');
